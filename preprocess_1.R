...
### read files
std_prb<-read.table(input_stdProb,sep="\t",header=T, check.names = FALSE, na.strings=c(""," ",".","NA"))
std_step<-read.table(input_stdStep,sep="\t",header=T, check.names = FALSE, na.strings=c(""," ",".","NA"))
